...
import ec.edu.unl.cc.succession.business.PrimeCubedCalculatorUpToLimit;
import ec.edu.unl.cc.succession.business.PrimeNumberCalculatorUpToLimit;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        switch (option){
            ...
            case (2): {
                serie = new PrimeCubedCalculatorUpToLimit(limit);
                break;
            }
            case (7): {
